...
function FeedPage() {
  ...
  useEffect(() => {
    ...
    const loadFeed = async () => {
      ...
      try {
        const response = await fetch(`${API_BASE_URL}/api/post/feed?page=${page}`, {
          method: 'GET',
          headers: {
    ...
    >
      <div className="container py-5">
        <div className="text-center mb-5">
          {/* <h2 className="fw-bold mb-2">Feed</h2> */}
          {/* <p className="text-muted mb-0">Posts from other users</p> */}
        </div>
        ...
        {isLoading ? (
          ...
          <div className="card border-0 shadow-sm rounded-4 text-center p-5 bg-white">
            <h5 className="fw-semibold mb-2">No feed posts available</h5>
            <p className="text-muted mb-0">When other users post, they will appear here.</p>
          </div>
        ) : (
          <>
            <div
                ...
                <div className="col-12 col-md-6 col-xl-4" key={post._id}>
                  <article className="card border-0 shadow-sm rounded-4 h-100 overflow-hidden">
                    ...
                    <div className="card-body d-flex flex-column">
                      <p className="small text-muted mb-2">By {post.author?.username || 'User'}</p>
        ...
        >
          ...
          >
            <div className="card-body p-4">
              ...
              <p className="small text-muted mb-1">By {focusedPost.author?.username || 'User'}</p>
